...
START_TEXT = (
    ...
    "• /analyse <code>BTC</code> ou <code>BTCUSDT</code> — crypto, actions, forex, indices\n"
...
HELP_TEXT = (
    ...
    "Exemples crypto : <code>BTC</code>, <code>ETH</code>, <code>PEPE</code>, <code>SOLUSDT</code>\n"
    "Exemples actions : <code>AAPL</code>, <code>TSLA</code>, <code>NVDA</code>\n"
    "Exemples forex : <code>EURUSD</code>, <code>GBPUSD</code>, <code>XAUUSD</code>\n"
    "Exemples indices : <code>SPX</code>, <code>NAS100</code>, <code>DAX</code>\n\n"
